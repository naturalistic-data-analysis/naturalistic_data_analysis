...
These approaches use one subject’s brain activity as a model for a second subject’s brain activity, reasoning that as long as two subjects receive the same input at the same time, any shared variance must be due to stimulus processing. If you haven't already, be sure to check out the [ISC tutorial](../content/Intersubject_Correlation) that is part of this book.
...
If this tutorial was useful to you, please consider citing this paper in addition to the [naturalistic-data-analysis book](http://naturalistic-data.org). Thanks!
...
- Luke Chang's [RSA tutorial](https://dartbrains.org/content/RSA.html) for the [dartbrains project](https://dartbrains.org/)
